...
public class UProcess {
     ...
     */
    public static boolean isReceiverDie(Context context, String receiverName, String actionName) {
        ...
        if (resolveInfos != null) {
            for (int index = 0; index < resolveInfos.size(); index++) {
                if (resolveInfos.get(index).activityInfo.packageName.trim().equals(Code.PKG_NAME)
